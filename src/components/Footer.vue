<template>
    <footer> 
        <a href="https://www.linkedin.com/in/caroline-justafre-54b6b017b/">
        ...
        <a href="https://github.com/Caroline-JTF">
...
<script>
    export default {
        ...
        data(){
            return {
                downloadPDF: "Caroline_JUSTAFRE.pdf",
                msg: "Portfolio crée par Justafre Caroline"
            }
        },
